...
meta =
{
    ...
    name = "asteroidrespawnsectornotifier",

    -- Title of your mod that will be displayed to players
    title = "Laserzwei's Asteroid respawning sectors notifier",

    -- Description of your mod that will be displayed to players
    description = "This mod adds an indicator when you are in a sector that respawns asterods.",
